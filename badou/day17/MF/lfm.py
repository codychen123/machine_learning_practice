...
class LFM(object):
    ...
    def fit(self, dataset):
        ...
        self.users_ratings = dataset.groupby(self.columns[0]).agg([list])[self.columns[1]]
...
if __name__ == '__main__':
    ...
    dataset = pd.read_csv("/Users/cody/Desktop/大数据/八斗19期/【19期-16day】召回项目07_牛逼的fm/code/all_path_for_recall/data/ua.base",sep="\t",header=None,names=["userId", "movieId", "rating","ts"])
